...
namespace TradingSystem{
    ...
    class FeatureEngine {
        public:
            ...
            auto onOrderBookUpdate(TickerId tickerId, Price price, Side side, const MarketOrderBook* orderBook) noexcept -> void;
            auto onTradeUpdate(const Exchange::MEMarketUpdate* market_update, const MarketOrderBook* orderBook) noexcept -> void;
